...
@Getter
@Setter
@Schema(name = "TechnicalResponsibleRequest", description = "Payload para criação de responsável técnico")
public class TechnicalResponsibleRequest {

    @Schema(description = "Nome do responsável técnico", example = "Homero de Assumpção Fernandes Silva", requiredMode = RequiredMode.REQUIRED)
    @NotBlank(message = "Nome é obrigatório")
    @Size(max = 255, message = "Nome deve ter no máximo 255 caracteres")
    private String name;

    @Schema(description = "CPF do responsável (11 dígitos ou formato xxx.xxx.xxx-xx)", example = "062.054.358-29", requiredMode = RequiredMode.REQUIRED)
